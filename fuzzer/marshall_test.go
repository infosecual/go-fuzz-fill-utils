...
import (
	...
	raceexample "github.com/infosecual/go-fuzz-fill-utils/examples/inputs/race"
...
func TestUnmarshalPlan(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			//    go-fuzz-fill-utils -chain -pkg=github.com/infosecual/go-fuzz-fill-utils/examples/inputs/race
