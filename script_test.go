...
import (
	...
	gen "github.com/infosecual/go-fuzz-fill-utils/gen"
)
...
func TestMain(m *testing.M) {
	os.Exit(testscript.RunMain(go-fuzz-fill-utilsTestingMain{m}, map[string]func() int{
		"go-fuzz-fill-utils": gen.FzgenMain,
	}))
}
...
type go-fuzz-fill-utilsTestingMain struct {
	m *testing.M
}

func (m go-fuzz-fill-utilsTestingMain) Run() int {
