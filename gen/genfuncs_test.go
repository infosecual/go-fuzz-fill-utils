...
func TestTypes(t *testing.T) {
	...
	for _, tt := range tests {
		...
		t.Run(tt.name, func(t *testing.T) {
			...
			pkgPattern := "github.com/infosecual/go-fuzz-fill-utils/examples/inputs/test-types"
...
func TestConstructorInjection(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			//    go-fuzz-fill-utils -ctors -pkg=github.com/infosecual/fzgo/genfuzzfuncs/examples/test-constructor-injection
		...
		{
			// this corresponds roughly to:
			//    go-fuzz-fill-utils -ctors=false -pkg=github.com/infosecual/fzgo/genfuzzfuncs/examples/test-constructor-injection
		...
		{
			// this corresponds roughly to:
			//    genfuzzfuncs -ctors -qualifyall=false -pkg=github.com/infosecual/fzgo/genfuzzfuncs/examples/test-constructor-injection
		...
		{
			// this corresponds roughly to:
			//    genfuzzfuncs -ctors=false -qualifyall=false -pkg=github.com/infosecual/fzgo/genfuzzfuncs/examples/test-constructor-injection
	...
	for _, tt := range tests {
		...
		t.Run(tt.name, func(t *testing.T) {
			t.Parallel()
			pkgPattern := "github.com/infosecual/go-fuzz-fill-utils/examples/inputs/test-constructor-injection"
			options := flagExcludeFuzzPrefix | flagMultiMatch
			if tt.onlyExported {
				options |= flagRequireExported
			}
...
func TestExported(t *testing.T) {
	...
	for _, tt := range tests {
		...
		t.Run(tt.name, func(t *testing.T) {
			...
			pkgPattern := "github.com/infosecual/go-fuzz-fill-utils/examples/inputs/test-exported"
			options := flagExcludeFuzzPrefix | flagMultiMatch
			if tt.onlyExported {
				options |= flagRequireExported
			}
