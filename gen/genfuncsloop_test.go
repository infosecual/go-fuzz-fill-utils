...
func TestChainRace(t *testing.T) {
	...
	for _, tt := range tests {
		...
		t.Run(tt.name, func(t *testing.T) {
			...
			pkgPattern := "github.com/infosecual/go-fuzz-fill-utils/examples/inputs/race"
...
func TestChainUUID(t *testing.T) {
	...
	for _, tt := range tests {
		...
		t.Run(tt.name, func(t *testing.T) {
			...
			pkgPattern := "github.com/infosecual/go-fuzz-fill-utils/examples/inputs/test-chain-uuid"
			options := flagExcludeFuzzPrefix | flagMultiMatch
			if tt.onlyExported {
				options |= flagRequireExported
			}
