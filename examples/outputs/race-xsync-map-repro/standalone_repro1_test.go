...
//     go-fuzz-fill-utils -chain -parallel -pkg=github.com/infosecual/go-fuzz-fill-utils/examples/inputs/race-xsyncmap
...
//
// Note: the original bug report was not via go-fuzz-fill-utils.
// This just looked like an interesting bug to try to reproduce with go-fuzz-fill-utils
...
import (
	...
	xsyncmap "github.com/infosecual/go-fuzz-fill-utils/examples/inputs/race-xsync-map"
)
