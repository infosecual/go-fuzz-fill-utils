...
replace (
	...
	github.com/infosecual/go-fuzz-fill-utils/examples/inputs/race-xsync-map => ./../../examples/inputs/race-xsync-map
)
...
require (
	...
	github.com/infosecual/go-fuzz-fill-utils/examples/inputs/race-xsync-map v0.0.0-00010101000000-000000000000
)
